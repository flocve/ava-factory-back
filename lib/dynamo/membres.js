...
export function updateMembre(args) {
  const params = {
    ...
    UpdateExpression: 'SET survivant = :survivant, val_blanc = :val_blanc, val_bleue = :val_bleue, Val_rouge = :Val_rouge, bullet_blanc = :bullet_blanc, bullet_bleue = :bullet_bleue, bullet_rouge = :bullet_rouge, localisations= :localisations',

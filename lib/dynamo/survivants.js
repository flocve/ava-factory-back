...
export function createSurvivant(args) {
  const params = {
    ...
    Item: {
      ...
      taille_socle: args.taille_socle,
      is_new: args.is_new,
    },
  };
...
export function updateSurvivant(args) {
  const params = {
    ...
    UpdateExpression: 'SET name = :name, cout = :cout, faction = :faction, img = :img, img_min = :img_min, , taille_socle = :taille_socle, is_new = :is_new',
